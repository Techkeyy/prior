...
def main():
    ...
    server_env = {
        ...
        "PRIOR_IDENTITY_DB": "/opt/prior/data/identity.db",
        "PRIOR_HOST": "127.0.0.1",
        "PRIOR_PORT": "8789",
        "PRIOR_BUILD_COMMIT": head_sha,
        "PRIOR_LOCAL_PROVIDER": "local",
        "PRIOR_PUBLIC_URL": local_env.get("PRIOR_PUBLIC_URL", "https://prior.103-195-188-198.sslip.io"),
        "PRIOR_COOKIE_SECURE": local_env.get("PRIOR_COOKIE_SECURE", "true"),
        "PRIOR_SESSION_TTL_S": local_env.get("PRIOR_SESSION_TTL_S", "7776000"),
        "GOOGLE_CLIENT_ID": local_env.get("GOOGLE_CLIENT_ID", ""),
        "GOOGLE_CLIENT_SECRET": local_env.get("GOOGLE_CLIENT_SECRET", ""),
        "EMAIL_PROVIDER": local_env.get("EMAIL_PROVIDER", ""),
        "EMAIL_SMTP_HOST": local_env.get("EMAIL_SMTP_HOST", ""),
        "EMAIL_SMTP_PORT": local_env.get("EMAIL_SMTP_PORT", "465"),
        "EMAIL_SMTP_TLS": local_env.get("EMAIL_SMTP_TLS", "ssl"),
        "EMAIL_SMTP_USER": local_env.get("EMAIL_SMTP_USER", ""),
        "EMAIL_SMTP_PASSWORD": local_env.get("EMAIL_SMTP_PASSWORD", ""),
        "EMAIL_FROM": local_env.get("EMAIL_FROM", ""),
        "ACP_ENABLED": "true",
        "PRIOR_ENABLE_ACP_WRITES": local_env.get("PRIOR_ENABLE_ACP_WRITES", "true"),
        "PRIOR_PUBLIC_MAX_JOB_USDC": local_env.get("PRIOR_PUBLIC_MAX_JOB_USDC", "0.50"),
        "PRIOR_PUBLIC_SPEND_LIMIT_USDC": local_env.get("PRIOR_PUBLIC_SPEND_LIMIT_USDC", "1.00"),
